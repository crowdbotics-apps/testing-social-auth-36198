...
## Project Structure
    ...
    ├── testing_social_auth_36198  # Django project configurations
...
1. Clone this repo and `cd testing_social_auth_36198`
...
2. Clone this repo and `cd testing_social_auth_36198`
